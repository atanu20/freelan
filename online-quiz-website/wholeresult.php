    ...
    <a class="dropdown-item" href="our_course.php">Our Courses</a>
      ...
      <div class="container qu">
          <div class="row">
              ...
              <div class="col-md-10 col-12 mx-auto shad p-2">
            ...
            <table class="table table-bordered">
              ...
              <tbody class=" tex-weight-bold text-danger">
...
$sequery="SELECT * FROM `result` ORDER BY persentage DESC, duration_exam ASC";
...
while($data= mysqli_fetch_array($query))
{
 ?>
                ...
                <tr>
                  ...
                  <td><?php echo $data['our_result']; ?></td>
                  <td><?php echo $data['attempt']; ?></td>
                 
                  <td><?php echo $data['not_attempt']; ?></td>
                  <td><?php echo $data['totalque']; ?></td>
                  <td><?php echo $data['persentage']; ?>%</td>
                  <td><?php echo $data['date']; ?></td>
                  <td><?php echo $data['duration_exam']; ?></td>
