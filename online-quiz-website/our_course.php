...
.shad{
  ...
  <a class="dropdown-item" href="user_result.php">Result</a>
    ...
    <a class="dropdown-item" href="our_course.php">Our Courses</a>
      ...
      <br><br>
      <h3 class="text-center text-primary font-weight-bold">Your All Courses</h3>
      <br><br>
          
             
<?php 
include "admin/connection.php";
$sequery="SELECT * FROM `enroll_course` WHERE user='$el' " ;
...
<a href="view_course.php?id=<?php echo $data['id'] ?>"  class="btn btn-danger float-right">Start Now</a>
