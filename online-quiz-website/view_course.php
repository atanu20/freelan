...
.shad{
  ...
  <a class="dropdown-item" href="user_result.php">Result</a>
    ...
    <a class="dropdown-item" href="our_course.php">Our Courses</a>
      ...
      <br><br>
      <h3 class="text-center text-primary font-weight-bold">View All Courses</h3>
      <br><br>
     <div class="row">
     <div class="col-md-4 col-12 mx-auto p-3">
     <h3 class="text-center text-primary font-weight-bold">View Lession</h3>
     <br>
     <?php
     include "admin/connection.php";
     $sequery="SELECT * FROM `lession` WHERE lesson_cos_id='$id' " ;
     ...
     while($data= mysqli_fetch_array($query))
     {
        ...
        <li class="nav-item border-bottom p-3" movieurl="<?php echo $data['lesson_video']  ?>" style="cursor:pointer;"><?php echo $data['lesson_title'] ?></li>
        </ul>
...
<div class="col-md-8 col-12 mx-auto " >
         <video id="videoarea" src="" class="p-2 w-100 h-100" controls style="outline:none">
    ...
    $(document).ready(function(){
        ...
        $(function(){
            $('#playlist li').on("click",function(){
                $('#videoarea').attr({
                    src: "lession/" +$(this).attr("movieurl"),
                });
            });
            ...
            $('#videoarea').attr({
                src: "lession/" + $('#playlist li').eq(0).attr("movieurl"),
            });
        });
    });
    </script>
