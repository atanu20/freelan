...
{
  $cat=$data['category'];
  $sequer="SELECT * FROM `result` WHERE category= '$cat' and user='$el'  ";
...
if($nums>0)
{
  ...
  <a href="down_button.php?category=<?php echo $cat;  ?>"><h2>Download Certificate on <?php echo $cat; ?> Quiz</h2></a>
