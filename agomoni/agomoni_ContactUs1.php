...
.b1{
    ...
    <div id="section4" class="container-fluid" style="padding-top: 60px;padding-bottom: 100px;">
       <div class="row">
      <div class="container">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" align="left">
        <p style="font-size: 18px;color: white;">We are ready to serve you. Just a text away and you can associate yourself with this initiative aimed at doing your own part for the society. Drop us a text and we will be there for you.</p><br>

        <p style="font-size: 17px;color: white;"><i>Mail us to know more:</i></p><br>

        <p style="font-size: 18px;color: white;">officialagomoni@gmail.com</p>

        <p style="font-size: 18px;color: white;">pragomoni@gmail.com<p>

        <p style="font-size: 18px;color: white;">agomonitech@gmail.com</p>
     </div>
   </div>
   </div>
    </div>
